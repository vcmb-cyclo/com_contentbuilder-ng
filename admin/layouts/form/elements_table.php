...
$columnOptions = [
    ...
    'order-type' => Text::_('COM_CONTENTBUILDERNG_ELEMENT_HEADING_ORDER_TYPE'),
...
if ($hasBfSystemFields) {
    $labelSplitOffset = $debugModeEnabled ? 4 : 3;
...
$defaultHiddenColumns = ['order-type', 'wordwrap'];
$visibleColumnCount = count($columnOptions);
$tableColumnCount = $hasBfSystemFields ? 15 : 14;
if ($debugModeEnabled) {
    $tableColumnCount++;
}
?>
...
<table class="table table-striped cb-elements-table" data-cb-elements-ordering="<?php echo $ordering ? '1' : '0'; ?>">
    <thead>
        <tr>
            ...
            <th id="cb-form-view-elements-heading-order-type" data-cb-col="order-type">
                <span class="editlinktip hasTip cb-elements-heading-label"
                    ...
                    <?php echo Text::_('COM_CONTENTBUILDERNG_ELEMENT_HEADING_ORDER_TYPE'); ?>
                </span>
            </th>
    ...
    <tbody>
        ...
        for ($i = 0; $i < $n; $i++) {
            ...
            <tr id="cb-row-<?php echo (int) $row->id; ?>" class="<?php echo 'row' . $k; ?>" data-cb-row-id="<?php echo (int) $row->id; ?>">
                ...
                <td class="align-top" data-cb-col="order-type">
                    <select class="form-select form-select-sm cb-item-order-type-select"
                        id="itemOrderTypes<?php echo (int) $row->id; ?>"
                        name="jform[itemOrderTypes][<?php echo (int) $row->id; ?>]"
                        title="<?php echo htmlspecialchars(Text::_('COM_CONTENTBUILDERNG_ORDER_TYPE_TIP'), ENT_QUOTES, 'UTF-8'); ?>"
                        aria-label="<?php echo htmlspecialchars(Text::_('COM_CONTENTBUILDERNG_ELEMENT_HEADING_ORDER_TYPE'), ENT_QUOTES, 'UTF-8'); ?>">
